...
function saleReportBetweenTwoDatesAsPerCat() {
	...
	var input1 = document.getElementById('fk_cat_id_for_payment_mode_two1'), list = document
			.getElementById('cat_drop_For_payment_mode_two1'), i, fk_cat_id;
	for (i = 0; i < list.options.length; ++i) {
		if (list.options[i].value === input1.value) {
			fk_cat_id = list.options[i].getAttribute('data-value');
		}
...
/*
 * function saleReportBetweenTwoDatesAsPerShopValidate() { var fkShopId =
 * $("#fk_shop_id").val(); var fDate = $("#fisDateForPay").val(); var sDate =
 * $("#endDateForPay").val();
 * 
 * if(fkShopId != "") { if(fDate != "") { if(sDate != "") {
 * saleReportBetweenTwoDatesAsPerShop() } else { alert("Please Enter Product
 * Category"); } } else { alert("Please Enter End Date"); } } else {
...
function saleReportBetweenTwoDatesAsPerShop() {
	...
	var input1 = document.getElementById('fkShopId'), list = document
			.getElementById('shp_drop'), i, fk_cat_id;
	for (i = 0; i < list.options.length; ++i) {
		if (list.options[i].value === input1.value) {
														...
														.DataTable(
																{
																	...
																	buttons : [
...

																			{
																				extend : 'print',
																				orientation : 'landscape',
																				title : 'Sale Return Reports Of Bill No: = '
																						+ bill_no,
																				footer : true,
																				pageSize : 'LEGAL'
																			},
...

																			{
																				...
																				title : 'Sale Return Reports Of Bill No: = '
																						+ bill_no,
																				messageTop : 'Sale Return Reports Of Bill No: = '
																						+ bill_no,
																				footer : true,
																				pageSize : 'LEGAL'
																			},
...
function getAllProductForSale() {
	...
	var input1 = document.getElementById('fk_cat_id_for_sale'), list = document
			.getElementById('cat_drop_For_sale'), i, fk_cat_id;
	for (i = 0; i < list.options.length; ++i) {
		if (list.options[i].value === input1.value) {
			fk_cat_id = list.options[i].getAttribute('data-value');
		}
...
function supplierWiseSale() {
	...
	var input1 = document.getElementById('fkSupplierId'), list = document
			.getElementById('sup_drop'), i, fkSupplierId;
	for (i = 0; i < list.options.length; ++i) {
		if (list.options[i].value === input1.value) {
...
function saleReportAsPerPaymentMode() {
	...
	var params = {};
	var input1 = document.getElementById('fk_cat_id_for_payment'), list = document
			.getElementById('cat_drop_For_payment'), i, fk_cat_id;
	for (i = 0; i < list.options.length; ++i) {
		if (list.options[i].value === input1.value) {
			fk_cat_id = list.options[i].getAttribute('data-value');
		}
...
function paymentModeReportAsPerSingleDate() {
	...
	if (document.datepaymentMode.paymentModeIdForDate.value == ""
			|| document.datepaymentMode.paymentModeIdForDate.value == "selected") {
...
function singleDatePaymentModeWiseSaleReport() {
	...
	var params = {};
	/*
	 * var input1 = document.getElementById('fk_cat_id_for_payment_mode'), list =
	 * document.getElementById('cat_drop_For_payment_mode'), i,fk_cat_id; for (i =
	 * 0; i < list.options.length; ++i) { if (list.options[i].value ===
	 * input1.value) { fk_cat_id = list.options[i].getAttribute('data-value'); } }
	 */
	...
	$
			.post(
					...
					function(data) {
						...
						if (catmap == null || catmap == "") {
							// alert("Date And Payment Mode Wise Sale
							// Reports\nDate = "+enterdate+"\nPayment Mode =
							// "+paymentModeIdForDate);
...
function twoDatePaymentModeWiseSaleReport() {
	 ...
	 * i,fk_cat_id; for (i = 0; i < list.options.length; ++i) { if
	 * (list.options[i].value === input1.value) { fk_cat_id =
...
function GSTWiseSaleReport1() {
	...
	var params = {};
	var input1 = document.getElementById('fk_cat_id_for_GST'), list = document
			.getElementById('cat_drop_For_GST'), i, fk_cat_id;
	for (i = 0; i < list.options.length; ++i) {
		if (list.options[i].value === input1.value) {
			fk_cat_id = list.options[i].getAttribute('data-value');
		}
	...
	$
			.post(
					...
					function(data) {
						...
						// $('#gstSale2').dataTable().fnClearTable();
						...
						console.log(catmap);
						if (catmap == null || catmap == "") {
							var msg = "Data is not available From " + startDate
									+ " To " + endDate;
							var dialog = bootbox.dialog({
								message : '<p class="text-center">'
										+ msg.fontcolor("red").fontsize(5)
						...
						var mydata = catmap;
						$('#gstSale2').dataTable().fnAddData(mydata);
...
function nonGSTWiseSaleReport() {
	...
	var params = {};
	var input1 = document.getElementById('fk_cat_id_for_nonGST'), list = document
			.getElementById('cat_drop_For_nonGST'), i, fk_cat_id;
	for (i = 0; i < list.options.length; ++i) {
		if (list.options[i].value === input1.value) {
			fk_cat_id = list.options[i].getAttribute('data-value');
		}
													...
													.DataTable(
															{
																 ...
																 * "defaultContent":
																 * ""}, {"data":
																 * "eighteenPercentageGST" ,
																 * "width":
																 * "5%",
																 * "defaultContent":
																 * ""}, {"data":
																 * "twentyEightPercentageGST",
																 * "width":
																 * "5%",
																 * "defaultContent":
																 * ""}, {"data":
...
function creditCustomerSaleReportBillAndNameWise() {
	...
	var input1 = document.getElementById('creditCustBillId'), list = document
			.getElementById('creditCustDrop'), i, creditCustBillNo;
	for (i = 0; i < list.options.length; ++i) {
		if (list.options[i].value === input1.value) {
	...
	$
			.post(
					...
					function(data) {
						...
						$('#creditCustSaleReportSingledate').dataTable()
								.fnClearTable();
						...
						$(document)
								.ready(
										function() {
											var total = $(
													'#creditCustSaleReportSingledate')
													.DataTable(
															{
...
function cashCustomerSaleReportBillAndNameWise() {
	...
	var input1 = document.getElementById('cashCustBillId'), list = document
			.getElementById('cashCustDrop'), i, cashCustBillNo;
	for (i = 0; i < list.options.length; ++i) {
		if (list.options[i].value === input1.value) {
	...
	$
			.post(
					...
					params,
					function(data) {
						$('#cashCustSaleReportSingledate').dataTable()
								.fnClearTable();
	...
	$
			.post(
					...
					function(data) {
						...
						$('#rangeWiseBillReportDataTable').dataTable()
								.fnClearTable();
...
function rangeAndPaymentModeWise() {
	/*
	 * var startdate = $("#fisDateForPay").val(); var enddate =
	 * $("#endDateForPay").val(); var category =
	 * $("#fk_cat_id_for_payment_mode_two").val();
	 */
	 ...
	 */
	/*
	 * var fDateForPaymentMode = $("#fisDateForPay").val(); var
	 * secondDateForPaymentMode = $("#endDateForPay").val();
	 */
	...
	$
			.post(
					...
					function(data) {
						...
						$('#rangeWisePaymentTypePaymentModeDataTable')
		...
		$(document).ready(function() {
			$('#saleReturnTable').DataTable({
...

				{
					extend : 'print',
					orientation : 'landscape',
					// title: 'Purchase Return Wise Purchase Report From
...

				{
					...
					// '+firstDate+' to '+secondDate+'\n'+'Supplier Name =
					// '+fkSupplierId_Purchase_Return,
					// messageTop: 'Purchase Return Wise Purchase Report From
					// '+firstDate+' to '+secondDate+'\n'+'Supplier Name =
					// '+fkSupplierId_Purchase_Return,
					footer : true,
					pageSize : 'LEGAL'
...
function allReportsss() {
	...
	/*
	 * var input1 = document.getElementById('fk_cat_id6'), list =
	 * document.getElementById('cat_drop6'), i,fk_cat_id; for (i = 0; i <
...
function saleReportBetweenTwoDatesAsPeruser1() {
	...
	var input1 = document.getElementById('fkShopIdd'), list = document
			.getElementById('shp_dropp'), i, fk_cat_id, fk_shop_id;
	for (i = 0; i < list.options.length; ++i) {
		if (list.options[i].value === input1.value) {
			fk_shop_id = list.options[i].getAttribute('data-value');
		}
	...
	$
			.post(
					...
					function(data) {
						...
						/*
						 * if(catmap == null || catmap == "") { alert("Packing
						 * Reports are Not Available for \nStart Date =
						 * "+startdateA+"\nEnd Date = "+enddateA); return false; }
						 */

						$(document)
								.ready(
										function() {
											var total = $('#dayclosure')
													.DataTable(
															{
