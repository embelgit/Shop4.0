...
var splitText = id.split(",");
	...
	var id = splitText[0];
	var name= splitText[1];
	var lname= splitText[2];
	  var r = confirm("Do You want to delete "+name+" "+lname);
	  if (r == true) {
