...
<%
	...
	Long billno = (Long) session
			.getAttribute("NormalCustFertilizerBillNo");
	...
	try {
		...
		ResultSet rs = stmt
				.executeQuery("select customer_name, fertilizer_billing.product_name,fertilizer_billing.gross_total, fertilizer_billing.village, fertilizer_billing.company, fertilizer_billing.weight, fertilizer_billing.quantity, fertilizer_billing.sale_price, fertilizer_billing.total_per_product, fertilizer_billing.total_all_product, fertilizer_billing.transportation_expense, fertilizer_billing.hamali_expense, fertilizer_billing.total_per_product, insert_date,fertilizer_billing.tax_percentage from fertilizer_billing where bill_no ="
						+ billno);
		...
		String strFertilizerBillDate = dateFormater
				.format(FertilizerBillDate);
		...
		Font font15BoldUnderline = new Font(
				Font.FontFamily.TIMES_ROMAN, 15, Font.BOLD
						| Font.UNDERLINE, BaseColor.BLACK);
		Font font12 = new Font(Font.FontFamily.TIMES_ROMAN, 12,
				Font.BOLD, BaseColor.BLACK);
		Font font12NoBold = new Font(Font.FontFamily.TIMES_ROMAN, 12,
				Font.NORMAL, BaseColor.BLACK);
		Font font12BoldUnderline = new Font(
		...
		Font Normalfont11 = new Font(Font.FontFamily.TIMES_ROMAN, 11,
				Font.NORMAL, BaseColor.BLACK);
		...
		table_cell = new PdfPCell(new Phrase(
				"Bill Cash/Credit Memorandum", Normalfont11));
		...
		table_cell = new PdfPCell(new Phrase(
				"Fertilizer No. LAFD25060096", Normalfont11));
		table_cell.setBorder(table_cell.NO_BORDER);
		table.addCell(table_cell);
		...
		table_cell = new PdfPCell(new Phrase(
				"MVAT TIN No. 27810107900V", Normalfont11));
		table_cell.setBorder(table_cell.NO_BORDER);
		table.addCell(table_cell);
		...
		table_cell = new PdfPCell(new Phrase("(S.)266462, (R.)266262",
				Normalfont11));
		table_cell.setBorder(table_cell.NO_BORDER);
		table.addCell(table_cell);
		...
		table_cell = new PdfPCell(new Phrase("Dudulwar Agencies",
				font15Bold));
		table_cell.setBorder(table_cell.NO_BORDER);
		table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
		table.addCell(table_cell);
		...
		table_cell = new PdfPCell(new Phrase(
				"Arnni, Dist.Yawatmal. 445103", Normalfont14));
		table_cell.setBorder(Rectangle.BOTTOM);
		table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
		table_cell.setPaddingBottom(20f);
		table.addCell(table_cell);
		...
		table_cell2 = new PdfPCell(
				new Phrase("Mr. " + custName, font12));
		table_cell2.setBorder(table_cell.NO_BORDER);
		smallTable.addCell(table_cell2);

		String expenses = String.valueOf(rs
				.getString("transportation_expense"));
		String HamaliExpence = String.valueOf(rs
				.getString("hamali_expense"));

		String gross_total = String
				.valueOf(rs.getString("gross_total"));

		table_cell2 = new PdfPCell(new Phrase("Village: "
				+ rs.getString("village")));
		table_cell2.setBorder(table_cell.NO_BORDER);
		table_cell2.setHorizontalAlignment(Element.ALIGN_RIGHT);
		smallTable.addCell(table_cell2);

		table_cell2 = new PdfPCell(new Phrase("Date: "
				+ strFertilizerBillDate));
		table_cell2.setBorder(table_cell.NO_BORDER);
		table_cell2.setHorizontalAlignment(Element.ALIGN_RIGHT);
		smallTable.addCell(table_cell2);
		...
		while (rs.next()) {
			...
			table_cell3 = new PdfPCell(new Phrase(product_name,
					font12NoBold));
			table_cell3.setBorder(Rectangle.RIGHT | Rectangle.LEFT);
			table_cell3.setBorderWidth(1f);
			...
			table_cell3 = new PdfPCell(new Phrase(
					manufacturing_company, font12NoBold));
			table_cell3.setBorder(Rectangle.RIGHT | Rectangle.LEFT);
			table_cell3.setBorderWidth(1f);
			table_cell3.setPaddingTop(2);
			table_cell3.setPaddingBottom(2);
			...
			table_cell3 = new PdfPCell(new Phrase(
					String.valueOf(weight), font12NoBold));
			table_cell3.setBorder(Rectangle.RIGHT | Rectangle.LEFT);
			...
			table_cell3 = new PdfPCell(new Phrase(
					String.valueOf(quantity), font12NoBold));
			table_cell3.setBorder(Rectangle.RIGHT | Rectangle.LEFT);
			table_cell3.setHorizontalAlignment(Element.ALIGN_CENTER);
			table_cell3.setBorderWidth(1f);
			table_cell3.setPaddingTop(2);
			...
			String sale_price = String.valueOf(rs
					.getString("sale_price"));
			table_cell3 = new PdfPCell(new Phrase(sale_price,
					font12NoBold));
			table_cell3.setBorder(Rectangle.RIGHT | Rectangle.LEFT);
			table_cell3.setHorizontalAlignment(Element.ALIGN_RIGHT);
			table_cell3.setBorderWidth(1f);
			...
			table_cell3 = new PdfPCell(new Phrase(
					String.valueOf(total), font12NoBold));
			table_cell3.setBorder(Rectangle.RIGHT | Rectangle.LEFT);
			table_cell3.setHorizontalAlignment(Element.ALIGN_RIGHT);
			table_cell3.setBorderWidth(1f);
			table_cell3.setPaddingTop(2);
		...
		table_cell3 = new PdfPCell(new Phrase("Transportation Expense",
				font13Bold));
		...
		table_cell3 = new PdfPCell(new Phrase("Hamali Expense",
				font13Bold));
		table_cell3.setColspan(7);
		table_cell3.setHorizontalAlignment(Element.ALIGN_RIGHT);
		table_cell3.setPaddingBottom(5f);
		...
		table_cell3 = new PdfPCell(new Phrase(df.format(Double
				.parseDouble(HamaliExpence)), font13Bold));
		table_cell3.setHorizontalAlignment(Element.ALIGN_RIGHT);
		table_cell3.setPaddingBottom(5f);
		table_cell3.setPaddingTop(5f);
		table_cell3.setBorderWidth(1f);
		...
		table_cell3 = new PdfPCell(
				new Phrase("Gross Total", font13Bold));
		table_cell3.setColspan(7);
		table_cell3.setHorizontalAlignment(Element.ALIGN_RIGHT);
		table_cell3.setPaddingBottom(5f);
		table_cell3.setPaddingTop(5f);
		...
		table_cell3 = new PdfPCell(
				new Phrase(
						"\n\n\n Customer Sign                    (Agriculture Use Only)                From Dudulwar Agencies",
						font12NoBold));
		table_cell3.setColspan(8);
		table_cell3.setHorizontalAlignment(Element.ALIGN_CENTER);
		table_cell3.setBorder(Rectangle.RIGHT | Rectangle.LEFT
