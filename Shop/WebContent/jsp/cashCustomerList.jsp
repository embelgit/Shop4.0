...
<link rel="stylesheet" href="/Shop/staticContent/css/shopstyle.css">	
		<title>Cash Customer List</title>
		
  		
  		<script type="text/javascript">
  			function Back()
  			{
  				window.location = "cashcustomerdetail.jsp" ;
  			}
...
<body id="dt_example" style="min-height:300px;">
	<div class="container-fluid">	
		<div class="row">
		    <div align="center" style="margin-top:70px">
		  		<h2 class="form-name style_heading">Cash Customer List</h2>
		  	</div>
	...
	List list12=dao.getCashCustomerList();
	%>
			...
			<tbody>
   				<%
					for(int i=0;i<list12.size();i++){
						cashCustomerHibernate sr=(cashCustomerHibernate)list12.get(i);
				%>
