...
function backToCreditCustomerList()
{
...
<meta charset="utf-8">
<script type="text/javascript" src="/Shop/staticContent/js/DeletCustomer.js"></script>
</head>
	...
	<div class="container col-sm-offset-2" >
        <form class="form-horizontal" method="post" action="" name="delCust"> <!-- Value of 'name' attribute is used in categoryDetails.js  -->
          <fieldset>
			 ...
			 <div class="row form-group">
           		<label class="col-md-offset-2  col-md-2  control-label" for="godown"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("godownName") %> <%}%> <%if(abc.equals("english")){%>Customer Name<%}%><sup>*</sup></label>  
            			...
            			<div class="input-group">
							...
							%>
							<select id="delCustName" class="form-control">
			...
			<!-- 	<datalist id="custName_drop1"> -->
							...
							<option ><%=bean1.getCustId()%>,<%=bean1.getFirstName()%> <%=bean1.getLastName()%></option>	
       ...
       <input type="button"  id="back" name="back" style="font-size: 25" class="btn btn-primary  button-height-width"  onclick="backToCreditCustomerList()" value="Back">
