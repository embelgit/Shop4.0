...
Long billno = (Long) session.getAttribute("advbookingId");
String shopName = (String) session.getAttribute("shopName");  
//String onlyShopName = (String) session.getAttribute("onlyShopName");  
//String billno = (String) session.getAttribute("advbookingId");
...
//		Class.forName(DatabaseProperties.dbDriver);
	...
	ResultSet rs = stmt.executeQuery("select pk_adv_book_id,product_name,company,buy_price,quantity,unit,total_amt_per_prod,grossTotal,sgst,cgst,iGstPercentage,shop_name,user_name,purchaseDate,buy_price_excl_tax,supplier_name,email_id from advance_booking where booking_no='"+billno+"' AND fk_shop_id = '"+shopid+"'");
...
/* 		headerTable_cell22 = new PdfPCell(new Phrase("Phone No. 024-222222", font9));
		...
		headerTable_cell22 = new PdfPCell(new Phrase("Purchase Order Invoice", font9Bold));
		headerTable_cell22.setHorizontalAlignment(Element.ALIGN_CENTER);
...
/* 				String tac = rs.getString("Tax_Amount");
				...
				double am = rs.getDouble("total_amt_per_prod");
