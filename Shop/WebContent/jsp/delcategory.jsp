...
function checkForDuplicateSubCategoryEntry(){
		...
		%>
		 	...
		 	<div class="row header_margin_top">
			    <div align="center">
			  		<h2 class="form-name style_heading"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("categoryDetails") %> <%}%> <%if(abc.equals("english")){%>Delete Category<%}%> </h2>
			  	</div>
           </div>
	...
	<!-- <------------------------------------- Category and Sub-Category Button ------------------------------------------->
         ...
         <div class="row form-group">
           		<label class="col-md-6  control-label" for="categoryName"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("catName") %> <%}%> <%if(abc.equals("english")){%> SelectCategory Name<%}%><sup>*</sup></label>  
           	 		<div class="col-md-3">
				...
				<div class="form-group row " style="padding-top:2%">
		            <div class="col-md-10 col-md-offset-1 text-center">
		           	...
		           	<input style=" height: 53px; width: 128px; font-size: 25" type="button" id="save1"  class="btn  btn-success button-height-width" name="btn" onclick="delcat()" value="Delete">
		       
		            <input style=" height: 53px; width: 128px; font-size: 25" type="button"   class="btn  btn-primary button-height-width" name="btn" onclick="catlist()" value="Back">
