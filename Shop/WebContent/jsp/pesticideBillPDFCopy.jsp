 ...
 <div class="container" style="float: left"> 
 		...
 		<div class="row">
			<div align="center" style="margin-top: 75px">
				  <h2 class="form-name style_heading">Pesticide Bill Copy</h2>
			</div>
 	 			...
 	 			<div id="NomCust" class="tab-pane fade in active">
 					<form action="" method="post" name="genIn">
 						<%
							...
							List list = fd.getNorCustBillAndClientNameForPestiBillCopy();
						%>
						<div class="row" style="margin-top: 25px;">
							<div class="col-md-offset-2">
								...
								<div class="col-md-4 col-md-offset-3" style="margin-top: 25px;" align="center">
									<button type="button" onclick="billGenerationForNormalPesti()" name="btn" class="btn btn-success" style="width:125px;height:45px;">Print </button>
								</div>
							</div>
						</div>
 					</form>
 	 			...
 	 			<div id="creditCustomer" class="tab-pane">
 					<form action="" method="post" name="genIn">
 						<%
							...
							List cclist = ccfd.getCreditCustBIllAndClientNameFoerPestiBillCopy();
						%> 
						<div class="row" style="margin-top: 25px;">
							<div class="col-md-offset-2">
								<div class="col-md-4">
								...
								<div class="col-md-4 col-md-offset-3" style="margin-top: 25px;" align="center">
									<button type="button" onclick="CreditCustBillGenerationForPesticide()" name="btn" class="btn btn-success" style="width:125px;height:45px;">Print </button>
								</div>
							</div>
						</div>
 					</form>
