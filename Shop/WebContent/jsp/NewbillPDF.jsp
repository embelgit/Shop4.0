...
//	}	
	...
	try
	{
		...
		Document document = new Document(PageSize.A4, 05f, 05f, 0f, 0f);
...
//		ResultSet rs = stmt.executeQuery("SELECT ccb.ItemName, ccb.CategoryName, ccb.Quantity, ccb.SalePrice, s.contact_no, ccb.TotalAmount, ccb.Discount, ccb.GrossTotal, ccb.Date, ccb.totalperitem, ccb.TaxAmount, s.first_name, s.last_name, ccb.Gst, ccb.Igst, ccb.HsnSacNo, ccb.payment_mode, ccb.BarcodeNo, ccb.billTime, sb.subcat_name, ccb.FkSaleEmployeeId, ud.userName, ccb.cashCard_cashAmount, ccb.cashCard_cardAmount, ccb.totalSaleReturnAmt, ccb.FkSaleEmployeeId, ccb.pending_bill_payment, ccb.taxAmtAfterDiscount FROM creditcustomerbill ccb JOIN customer_details s ON ccb.fkCrediCustId=s.pk_customer_id JOIN sub_categories sb ON ccb.fkSubCatId=sb.pk_subcat_id JOIN user_details ud on ccb.cEmpIdFk=ud.pk_user_id where ccb.BillNo = "+billno);
	...
	ResultSet rs = stmt.executeQuery("select fk_customer_id, bill_no, customer_name, credit_customer_name, fb.product_name, fb.village, fb.company, fb.weight, fb.Without_Tax_Rate, fb.total_per_product, fb.total_all_product, fb.hamali_expense, fb.gross_total, fb.tax_percentage, fb.hsn,fb.igstPercentage, fb.fk_shop_id, s.shop_name,fb.Discount_amount ,fb.sale_price, fb.kg, fb.grams, fb.unit, fb.ltr, fb.mili, fb.quantity, fb.total_per_product, fb.kg, fb.grams, fb.ltr, fb.mili, fb.contact_number, fb.GST_No, s.address, fb.saleDate, fb.freeQuantity, fb.net_pay_amount, fb.discount_per_product_perc, fb.description,fb.Discount_perc,fb.total_gst_tax_per_product,fb.igst_tax_amount_per_unit,fb.sale_price,fb.unit,fb.cust_type,fb.village from fertilizer_billing fb left join shop_details s on fk_shop_id=pk_shop_id where bill_no = " +billno);
		...
		Font cast1 = new Font(Font.FontFamily.HELVETICA, 24, Font.BOLD, BaseColor.BLACK);
...
/* 					PdfPTable headertable = new PdfPTable(1);
	...
	headerTable_cell22.setPaddingTop(7);
	headerTable_cell22.setPaddingBottom(7);
	headerTable_cell22.setFixedHeight(50f);				
...
/* 		headerTable_cell22 = new PdfPCell(new Phrase(""));
		...
		headerTable_cell22.setHorizontalAlignment(Element.ALIGN_CENTER);
		headerTable_cell22.setPaddingBottom(30);
		headerTable_cell22.setPaddingTop(30);
...
//		document.add(headertable21);
		...
		headerTable_cell21.setPaddingTop(5);
...
/* 		headerTable_cell21 = new PdfPCell(new Phrase("Type :   "+type, font8));
		...
		headerTable_cell26.setPaddingBottom(5);
		headerTable_cell26.setPaddingTop(5);
		...
		headerTable_cell27.setPaddingBottom(5);
		headerTable_cell27.setPaddingTop(5);
		...
		headerTable_cell28.setPaddingBottom(5);
		headerTable_cell28.setPaddingTop(5);
...
//		table9.setSpacingAfter(5);
		...
		PdfPCell cell1 = new PdfPCell(new Paragraph("SR.No.", font12Bold));
...
/* 			table_cell = new PdfPCell(new Phrase("", font13));
	...
	//		footerTable_cell3aa.setPaddingBottom(10);
			...
			footerTable_cell3a.setPaddingBottom(10);
			...
			footerTable_cell3a = new PdfPCell(new Phrase("TOTAL",Normalfont10));
			footerTable_cell3a.setHorizontalAlignment(Element.ALIGN_CENTER);
			footerTable_cell3a.setBorder(Rectangle.BOTTOM | Rectangle.RIGHT);
			footerTable_cell3a.setPaddingBottom(20);
			footerTable_cell3a.setPaddingTop(20);
			footerTable3aa.addCell(footerTable_cell3a);
...
/* 			footerTable_cell3a = new PdfPCell(new Phrase("Discount Amount  :  "+dd+"        Net Amount    : "+gg, font8Bold));
	...
	//		footerTable_cell3aa.setPaddingBottom(10);
			...
			footerTable_cell3 = new PdfPCell(new Phrase("           TIME \n \n 10:30 AM to 7 PM \n \n Smile is the best medicine in the world", font12Bold));
			footerTable_cell3.setHorizontalAlignment(Element.ALIGN_LEFT);
			footerTable_cell3.setPaddingLeft(10);
			footerTable_cell3.setPaddingBottom(15);
			footerTable_cell3.setPaddingTop(70);
