...
<meta charset="utf-8">
<script type="text/javascript" src="/Shop/staticContent/js/godownDetails.js"></script>
</head>
		 	<div class="row header_margin_top">
			    <div align="center">
			  		<h2 class="form-name style_heading"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("godownDetails") %> <%}%> <%if(abc.equals("english")){%>Godown Details<%}%> </h2>
			  	</div>
	...
	<div class="container col-sm-offset-2" >
        <form class="form-horizontal" method="post" action="" name="godown"> <!-- Value of 'name' attribute is used in categoryDetails.js  -->
          <fieldset>
			<div class="row form-group">
			 ...
			 <div class="row form-group">
           		<label class="col-md-offset-2  col-md-2  control-label" for="godown"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("godownName") %> <%}%> <%if(abc.equals("english")){%>Godown Name<%}%><sup>*</sup></label>  
           	 		<div class="col-md-3">
				...
				<datalist id="unitName_drop1">
							...
							<option data-value="<%=bean1.getPkGodownId()%>" value="<%=bean1.getGodownName()%>">
							<%
				      			}
				    		%>
       ...
       <input type="button"  id="btn" name="btn" style="font-size: 25" class="btn btn-large btn-success glyphicon glyphicon-save  button-height-width"  onclick="GoDetails()" value="Submit">
