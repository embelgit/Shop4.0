...
<%
	...
	try {
		...
		table_cell = new PdfPCell(new Phrase("Fertilizer No. LAFD25060096", Normalfont11));
		table_cell.setBorder(table_cell.NO_BORDER);
		table.addCell(table_cell);
		...
		table_cell = new PdfPCell(new Phrase("(S.)266462, (R.)266262", Normalfont11));
		table_cell.setBorder(table_cell.NO_BORDER);
		table.addCell(table_cell);
