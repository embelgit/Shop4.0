...
try {
	...
	rs.first();
		...
		Long mobileNo = rs.getLong("contactNo");
		String gstNo = rs.getString("gstNo");
		
		/* if(ShopId == 1)
		{ */
			
			table_cell = new PdfPCell(new Phrase("Bill Cash/Credit Memorandum", font9NoBold));
			...
			table_cell = new PdfPCell(new Phrase("Bill No: "+shopPrBillno, font9NoBold));
...
*/
		...
		float[] columnWidths3 = { 0.4f, 0.3f, 0.2f, 0.2f, 0.1f, 0.2f, 0.2f, 0.2f, 0.3f};
		...
		float[] columnWidths4 = { 0.4f, 0.3f, 0.2f, 0.2f, 0.1f, 0.2f, 0.2f, 0.2f, 0.3f};
		table4.setWidths(columnWidths4);

		PdfPTable table5 = new PdfPTable(9);
		table5.setWidthPercentage(100);

		float[] columnWidths5 = { 0.4f, 0.3f, 0.2f, 0.2f, 0.1f, 0.2f, 0.2f, 0.2f, 0.3f};
		...
		float[] columnWidths7 = { 0.4f, 0.3f, 0.2f, 0.2f, 0.1f, 0.2f, 0.2f, 0.2f, 0.3f};
...
//		table6.addCell(cell10);
	...
	{	
		while (rs.next())
		{			
				System.out.println("ln no 510 ==> when b<10");
				System.out.println("ln no 511 == VALUE OF ==> b "+b);
				...
				if(unit.equalsIgnoreCase("kg"))
					{
						table_cell4 = new PdfPCell(new Phrase(String.valueOf(kgAndGrams), font9NoBold));
						table_cell4.setBorder(table_cell4.NO_BORDER);
						table_cell4.setHorizontalAlignment(Element.ALIGN_CENTER);
						table_cell4.setBorderWidth(1f);
						table_cell4.setPaddingTop(2);
					...
					{
						table_cell4 = new PdfPCell(new Phrase(String.valueOf(ltrAndMili), font9NoBold));
						table_cell4.setBorder(table_cell4.NO_BORDER);
						table_cell4.setHorizontalAlignment(Element.ALIGN_CENTER);
						table_cell4.setBorderWidth(1f);
						table_cell4.setPaddingTop(2);
...
//document.add(table4);
		...
		if (rows > 0 && rows <= 10)
		{
			...
			table_cell9 = new PdfPCell(new Phrase("*Good Once Sold will not be taken Back.",font8NoBold));
		...
		{			
			...
			table_cell4 = new PdfPCell(new Phrase("Gross Total  :-  "+ df.format(Double.parseDouble(gross_total)), font12));
			table_cell4.setColspan(4);
			table_cell4.setHorizontalAlignment(Element.ALIGN_CENTER);
			table_cell4.setBorder(Rectangle.NO_BORDER);
			table_cell4.setPaddingBottom(1f);
