...
<%
	response.setContentType("application/pdf");
	 Long billno = (Long) session.getAttribute("pestiBillNo");
	 String creditCustomerName = (String) session.getAttribute("PesticreditCustomerName"); 
	...
	try {
		...
		ResultSet rs = stmt.executeQuery("select customer_name, pesticide_billing.product_name, pesticide_billing.village, pesticide_billing.company, pesticide_billing.weight, pesticide_billing.quantity, pesticide_billing.sale_price, pesticide_billing.total_per_product, pesticide_billing.total_all_product, pesticide_billing.transportation_expense, pesticide_billing.hamali_expense, pesticide_billing.gross_total, pesticide_billing.tax_percentage from pesticide_billing where bill_no =" + billno);
