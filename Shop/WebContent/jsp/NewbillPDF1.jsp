...
//		Document document = new Document(PageSize.A7.rotate(), 20f, 10f, 10f, 0f);
	//	document.setMargins(7 , 415 , 7 , 0);
...
//		ResultSet rs = stmt.executeQuery("SELECT ccb.ItemName, ccb.CategoryName, ccb.Quantity, ccb.SalePrice, s.contact_no, ccb.TotalAmount, ccb.Discount, ccb.GrossTotal, ccb.Date, ccb.totalperitem, ccb.TaxAmount, s.first_name, s.last_name, ccb.Gst, ccb.Igst, ccb.HsnSacNo, ccb.payment_mode, ccb.BarcodeNo, ccb.billTime, sb.subcat_name, ccb.FkSaleEmployeeId, ud.userName, ccb.cashCard_cashAmount, ccb.cashCard_cardAmount, ccb.totalSaleReturnAmt, ccb.FkSaleEmployeeId, ccb.pending_bill_payment, ccb.taxAmtAfterDiscount FROM creditcustomerbill ccb JOIN customer_details s ON ccb.fkCrediCustId=s.pk_customer_id JOIN sub_categories sb ON ccb.fkSubCatId=sb.pk_subcat_id JOIN user_details ud on ccb.cEmpIdFk=ud.pk_user_id where ccb.BillNo = "+billno);
	...
	ResultSet rs = stmt.executeQuery("select fk_customer_id, bill_no, customer_name, credit_customer_name, fb.product_name, fb.village, fb.company, fb.weight, fb.Without_Tax_Rate, fb.total_per_product, fb.total_all_product, fb.hamali_expense, fb.gross_total, fb.tax_percentage, fb.hsn,fb.igstPercentage, fb.fk_shop_id, s.shop_name,fb.Discount_amount ,fb.sale_price, fb.kg, fb.grams, fb.unit, fb.ltr, fb.mili, fb.quantity, fb.total_per_product, fb.kg, fb.grams, fb.ltr, fb.mili, fb.contact_number, fb.GST_No, s.address, fb.saleDate, fb.freeQuantity, fb.net_pay_amount, fb.discount_per_product_perc, fb.description,fb.Discount_perc,fb.total_gst_tax_per_product,fb.igst_tax_amount_per_unit,fb.sale_price,fb.unit,fb.cust_type,fb.village,fb.email from fertilizer_billing fb left join shop_details s on fk_shop_id=pk_shop_id where bill_no = " +billno);
		...
		Font cast = new Font(Font.FontFamily.COURIER, 24, Font.BOLD, BaseColor.BLACK);
		Font cast1 = new Font(Font.FontFamily.HELVETICA, 24, Font.BOLD, BaseColor.RED);
		Font cast2 = new Font(Font.FontFamily.ZAPFDINGBATS, 17, Font.BOLD, BaseColor.BLACK);
		Font cast3 = new Font(Font.FontFamily.SYMBOL, 17, Font.BOLD, BaseColor.BLACK);
...
/* 					PdfPTable headertable = new PdfPTable(1);
		...
		float[] HeadercolumnWidths22 = { 0.5f,0.9f };
		headertable22.setWidths(HeadercolumnWidths22);

		PdfPCell headerTable_cell22;

		
		Image image1 = Image.getInstance("C:/logo.jpg");
	image1.scaleToFit(10f, 10f);
	Image imageCenter = Image.getInstance(image1);
	imageCenter.setAlignment(Image.ALIGN_LEFT);
	headerTable_cell22 = new PdfPCell(new Phrase("", font12));
	headerTable_cell22.setImage(image1);
	headerTable_cell22.setPaddingTop(2);
	headerTable_cell22.setPaddingBottom(2);
	headerTable_cell22.setFixedHeight(30f);				
...
/* 		headerTable_cell22 = new PdfPCell(new Phrase(""));
		...
		headerTable_cell22 = new PdfPCell(new Phrase("ARYAN \n Enterprises",cast1));
		headerTable_cell22.setHorizontalAlignment(Element.ALIGN_CENTER);
		headerTable_cell22.setPaddingBottom(10);
		headerTable_cell22.setPaddingTop(10);
...
//		headerTable_cell22.setBorder(Rectangle.NO_BORDER);
	...
	/* 	
		PdfPTable headertable24 = new PdfPTable(1);
		headertable24.setWidthPercentage(100);

		float[] HeadercolumnWidths24 = { 1f };
		headertable24.setWidths(HeadercolumnWidths24);

		PdfPCell headerTable_cell24;

		headerTable_cell24 = new PdfPCell(new Phrase(" "));
		headerTable_cell24.setHorizontalAlignment(Element.ALIGN_RIGHT);
//		headerTable_cell24.setPaddingBottom(10);
//		headerTable_cell24.setPaddingTop(10);
		headerTable_cell24.setBorder(Rectangle.RIGHT | Rectangle.LEFT | Rectangle.BOTTOM | Rectangle.TOP);
		headertable24.addCell(headerTable_cell24);
		
		document.add(headertable24); */
		
		
		PdfPTable headertable25 = new PdfPTable(1);
		headertable25.setWidthPercentage(100);

		float[] HeadercolumnWidths25 = { 1f };
		headertable25.setWidths(HeadercolumnWidths25);

		PdfPCell headerTable_cell25;

		headerTable_cell25 = new PdfPCell(new Phrase(" "));
		headerTable_cell25.setHorizontalAlignment(Element.ALIGN_RIGHT);
		headerTable_cell25.setPaddingBottom(1);
		headerTable_cell25.setPaddingTop(1);
		headerTable_cell25.setBorder(Rectangle.RIGHT | Rectangle.LEFT | Rectangle.BOTTOM | Rectangle.TOP);
		headertable25.addCell(headerTable_cell25);
		...
		float[] HeadercolumnWidths21 = { 0.2f,0.15f,0.1f,0.15f, 0.2f };
...
//		document.add(headertable21);
		...
		headerTable_cell21 = new PdfPCell(new Phrase("BILL NO. :", font12Bold));
		headerTable_cell21.setBorder(Rectangle.RIGHT | Rectangle.LEFT | Rectangle.BOTTOM | Rectangle.TOP);
		headerTable_cell21.setHorizontalAlignment(Element.ALIGN_LEFT);
		headerTable_cell21.setPaddingBottom(2);
		headerTable_cell21.setPaddingTop(2);
		headerTable_cell21.setPaddingLeft(10);
		headertable21.addCell(headerTable_cell21);

		headerTable_cell21 = new PdfPCell(new Phrase(bb, font12));
		headerTable_cell21.setBorder(Rectangle.RIGHT | Rectangle.BOTTOM | Rectangle.TOP);
		headerTable_cell21.setHorizontalAlignment(Element.ALIGN_LEFT);
		headerTable_cell21.setPaddingBottom(2);
		headerTable_cell21.setPaddingTop(2);
		headerTable_cell21.setPaddingLeft(15);
		headertable21.addCell(headerTable_cell21);
		...
		headerTable_cell21 = new PdfPCell(new Phrase("BILL DATE:", font12));
		headerTable_cell21.setBorder(Rectangle.RIGHT  | Rectangle.BOTTOM | Rectangle.TOP);
		headerTable_cell21.setHorizontalAlignment(Element.ALIGN_LEFT);
		headerTable_cell21.setPaddingBottom(2);
		headerTable_cell21.setPaddingTop(2);
		headerTable_cell21.setPaddingLeft(5);
		headertable21.addCell(headerTable_cell21);

		headerTable_cell21 = new PdfPCell(new Phrase(cdate, font12));
		headerTable_cell21.setHorizontalAlignment(Element.ALIGN_CENTER);
		headerTable_cell21.setBorder(Rectangle.RIGHT  | Rectangle.BOTTOM | Rectangle.TOP);
		headerTable_cell21.setPaddingBottom(2);
		headerTable_cell21.setPaddingTop(2);
...
/* 		headerTable_cell21 = new PdfPCell(new Phrase("Type :   "+type, font8));
		...
		String ct = rs.getString("cust_type");
		String cus = "";
		if(ct.equals("Cash"))
		{
			cus = rs.getString("customer_name");
		}
		else{
			cus = rs.getString("credit_customer_name");
		}
		PdfPTable headertable26 = new PdfPTable(2);
		headertable26.setWidthPercentage(100);

		float[] HeadercolumnWidths26 = { 0.2f,0.6f };
		headertable26.setWidths(HeadercolumnWidths26);

		PdfPCell headerTable_cell26;

		headerTable_cell26 = new PdfPCell(new Phrase("NAME :",font12Bold));
		headerTable_cell26.setHorizontalAlignment(Element.ALIGN_LEFT);
		headerTable_cell26.setPaddingBottom(2);
		headerTable_cell26.setPaddingTop(2);
		headerTable_cell26.setPaddingLeft(10);
		headerTable_cell26.setBorder(Rectangle.RIGHT | Rectangle.LEFT | Rectangle.BOTTOM | Rectangle.TOP);
		headertable26.addCell(headerTable_cell26);
		
		headerTable_cell26 = new PdfPCell(new Phrase(cus,font12Bold));
		headerTable_cell26.setHorizontalAlignment(Element.ALIGN_LEFT);
		headerTable_cell26.setPaddingBottom(2);
		headerTable_cell26.setPaddingTop(2);
		headerTable_cell26.setPaddingLeft(15);
		headerTable_cell26.setBorder(Rectangle.RIGHT | Rectangle.BOTTOM | Rectangle.TOP);
		headertable26.addCell(headerTable_cell26);
		
		document.add(headertable26);
		
		PdfPTable headertable27 = new PdfPTable(2);
		headertable27.setWidthPercentage(100);

		float[] HeadercolumnWidths27 = { 0.2f,0.6f };
		headertable27.setWidths(HeadercolumnWidths27);

		PdfPCell headerTable_cell27;
		String ad = rs.getString("village");
		System.out.println("````````````````````````````` vill "+ad);
		headerTable_cell27 = new PdfPCell(new Phrase("ADDRESS : ",font12Bold));
		headerTable_cell27.setHorizontalAlignment(Element.ALIGN_LEFT);
		headerTable_cell27.setPaddingBottom(3);
		headerTable_cell27.setPaddingTop(3);
		headerTable_cell27.setPaddingLeft(10);
		headerTable_cell27.setBorder(Rectangle.RIGHT | Rectangle.LEFT | Rectangle.BOTTOM | Rectangle.TOP);
		headertable27.addCell(headerTable_cell27);
		
		headerTable_cell27 = new PdfPCell(new Phrase(ad,font12Bold));
		headerTable_cell27.setHorizontalAlignment(Element.ALIGN_LEFT);
		headerTable_cell27.setPaddingBottom(3);
		headerTable_cell27.setPaddingTop(3);
		headerTable_cell27.setPaddingLeft(15);
		headerTable_cell27.setBorder(Rectangle.RIGHT | Rectangle.BOTTOM | Rectangle.TOP);
		headertable27.addCell(headerTable_cell27);
		
		document.add(headertable27);
		
		
		PdfPTable headertable28 = new PdfPTable(2);
		headertable28.setWidthPercentage(100);

		float[] HeadercolumnWidths28 = { 0.2f,0.6f };
		headertable28.setWidths(HeadercolumnWidths28);

		PdfPCell headerTable_cell28;

		headerTable_cell28 = new PdfPCell(new Phrase("CONTACT NO. : ",font12Bold));
		headerTable_cell28.setHorizontalAlignment(Element.ALIGN_LEFT);
		headerTable_cell28.setPaddingBottom(2);
		headerTable_cell28.setPaddingTop(2);
		headerTable_cell28.setPaddingLeft(10);
		headerTable_cell28.setBorder(Rectangle.RIGHT | Rectangle.LEFT | Rectangle.BOTTOM | Rectangle.TOP);
		headertable28.addCell(headerTable_cell28);
		
		String cc = rs.getString("contact_number");
		System.out.println("````````````````````````````` con "+cc);
		headerTable_cell28 = new PdfPCell(new Phrase(cc,font12Bold));
		headerTable_cell28.setHorizontalAlignment(Element.ALIGN_LEFT);
		headerTable_cell28.setPaddingBottom(2);
		headerTable_cell28.setPaddingTop(2);
		headerTable_cell28.setPaddingLeft(15);
		headerTable_cell28.setBorder(Rectangle.RIGHT | Rectangle.BOTTOM | Rectangle.TOP);
		headertable28.addCell(headerTable_cell28);
		...
		float[] HeadercolumnWidths29 = { 1f };
		headertable29.setWidths(HeadercolumnWidths29);

		PdfPCell headerTable_cell29;

		headerTable_cell29 = new PdfPCell(new Phrase(" "));
		headerTable_cell29.setHorizontalAlignment(Element.ALIGN_RIGHT);
		headerTable_cell29.setPaddingBottom(1);
		headerTable_cell29.setPaddingTop(1);
		headerTable_cell29.setBorder(Rectangle.RIGHT | Rectangle.LEFT | Rectangle.BOTTOM | Rectangle.TOP);
		headertable29.addCell(headerTable_cell29);
...
//		table.setSpacingAfter(5);
		...
		float[] columnWidths = {0.1f,0.9f,0.1f,0.3f};//{ 0.1f, 0.7f, 0.3f, 0.3f, 0.3f, 0.5f };
...
//		table1.setSpacingAfter(5);
		...
		float[] columnWidths1 ={0.1f,0.9f,0.1f,0.3f};
...
//		table2.setSpacingAfter(5);
		...
		float[] columnWidths2 ={0.1f,0.9f,0.1f,0.3f};
...
//		table3.setSpacingAfter(5);
		...
		float[] columnWidths3 = {0.1f,0.9f,0.1f,0.3f};
...
//		table4.setSpacingAfter(5);
		...
		float[] columnWidths4 = {0.1f,0.9f,0.1f,0.3f};
...
//		table5.setSpacingAfter(5);
		...
		float[] columnWidths5 = {0.1f,0.9f,0.1f,0.3f};
...
//		table6.setSpacingAfter(5);
		...
		float[] columnWidths6 = {0.1f,0.9f,0.1f,0.3f};
...
//		table7.setSpacingAfter(5);
		...
		float[] columnWidths7 ={0.1f,0.9f,0.1f,0.3f};
...
//		table8.setSpacingAfter(5);
		...
		float[] columnWidths8 = {0.1f,0.9f,0.1f,0.3f};
...
//		table9.setSpacingAfter(5);
		...
		float[] columnWidths9 ={0.1f,0.9f,0.1f,0.3f};
		table9.setWidths(columnWidths9);

		PdfPCell table_cell;
		rs.beforeFirst();

		PdfPCell cell1 = new PdfPCell(new Paragraph("SR.", font12Bold));
	...
	//	cell1.setBorder(cell1.NO_BORDER);
		...
		cell1.setBorder(Rectangle.BOTTOM | Rectangle.LEFT | Rectangle.RIGHT);
 		...
 		PdfPCell cell5 = new PdfPCell(new Paragraph("PARTICULARS", font14Bold));
		cell5.setHorizontalAlignment(Element.ALIGN_CENTER);
	//	cell5.setBorder(cell5.NO_BORDER);
			cell5.setPaddingBottom(1f);
			cell5.setPaddingTop(1f);
		cell5.setBorder(Rectangle.BOTTOM | Rectangle.RIGHT); 
		
		PdfPCell cell2 = new PdfPCell(new Paragraph("", font14Bold));
...
/* 		PdfPCell cell3 = new PdfPCell(new Paragraph("Rate", font8Bold));
	...
	//	cell3.setBorder(cell3.NO_BORDER);
		...
		PdfPCell cell4 = new PdfPCell(new Paragraph("AMOUNT", font14Bold));
		cell4.setHorizontalAlignment(Element.ALIGN_CENTER);
	//	cell4.setBorder(cell4.NO_BORDER);
			cell4.setPaddingBottom(1f);
...
/* 		PdfPTable footerTable3aaaas = new PdfPTable(4);
		footerTable3aaaas.setWidthPercentage(100);

		float[] footerColumnWidths3aaas = {0.1f,0.9f,0.1f,0.3f};
		footerTable3aaaas.setWidths(footerColumnWidths3aaas);

		PdfPCell footerTable_cell3aaas;


		footerTable_cell3aaas = new PdfPCell(new Phrase(" "));
		footerTable_cell3aaas.setHorizontalAlignment(Element.ALIGN_RIGHT);
		footerTable_cell3aaas.setBorder(Rectangle.BOTTOM | Rectangle.LEFT | Rectangle.RIGHT);
//		footerTable_cell3aa.setPaddingBottom(10);
		footerTable3aaaas.addCell(footerTable_cell3aaas);
		
		footerTable_cell3aaas = new PdfPCell(new Phrase(" "));
		footerTable_cell3aaas.setHorizontalAlignment(Element.ALIGN_RIGHT);
		footerTable_cell3aaas.setBorder(Rectangle.BOTTOM | Rectangle.RIGHT);
//		footerTable_cell3aa.setPaddingBottom(10);
		footerTable3aaaas.addCell(footerTable_cell3aaas);
		
		footerTable_cell3aaas = new PdfPCell(new Phrase(" ",Normalfont10));
		footerTable_cell3aaas.setHorizontalAlignment(Element.ALIGN_CENTER);
		footerTable_cell3aaas.setBorder(Rectangle.BOTTOM | Rectangle.RIGHT);
//		footerTable_cell3aa.setPaddingBottom(10);
		footerTable3aaaas.addCell(footerTable_cell3aaas);

				
		footerTable_cell3aaas = new PdfPCell(new Phrase(" ", font14Bold));
		footerTable_cell3aaas.setHorizontalAlignment(Element.ALIGN_CENTER);
		footerTable_cell3aaas.setBorder(Rectangle.BOTTOM | Rectangle.RIGHT);
//		footerTable_cell3aa.setPaddingBottom(10);
		footerTable3aaaas.addCell(footerTable_cell3aaas);
		
		document.add(footerTable3aaaas); */
		...
		while (rs.next())
		{
			...
			if(i==1){
			table_cell = new PdfPCell(new Phrase(" ", Normalfont14));
			...
			table.addCell(table_cell);
				...
				table_cell = new PdfPCell(new Phrase(""+i, Normalfont14));
				table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				table_cell.setPaddingBottom(2);			
	//			table_cell.setPaddingTop(2);
				table_cell.setBorder(Rectangle.BOTTOM | Rectangle.LEFT | Rectangle.RIGHT);
				table.addCell(table_cell);

				table_cell = new PdfPCell(new Phrase("" + itemName , Normalfont14));
				table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				table_cell.setPaddingBottom(2);			
	//			table_cell.setPaddingTop(2);
				table_cell.setBorder(Rectangle.BOTTOM | Rectangle.RIGHT);
...
/* 				table_cell = new PdfPCell(new Phrase("" + disAmtCmp, font8));
				...
				table_cell = new PdfPCell(new Phrase(""+am, Normalfont14));
				table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				table_cell.setPaddingBottom(2);			
//				table_cell.setPaddingTop(2);
				table_cell.setBorder(Rectangle.BOTTOM | Rectangle.RIGHT);
...
/* 			table_cell = new PdfPCell(new Phrase("", font13));
			...
			PdfPTable footerTable3aaa = new PdfPTable(4);
			footerTable3aaa.setWidthPercentage(100);

			float[] footerColumnWidths3aa = {0.1f,0.9f,0.1f,0.3f};
			footerTable3aaa.setWidths(footerColumnWidths3aa);

			PdfPCell footerTable_cell3aa;


			footerTable_cell3aa = new PdfPCell(new Phrase(" "));
			footerTable_cell3aa.setHorizontalAlignment(Element.ALIGN_RIGHT);
			footerTable_cell3aa.setBorder(Rectangle.BOTTOM | Rectangle.LEFT | Rectangle.RIGHT);
			footerTable_cell3aa.setPaddingBottom(1);
			footerTable_cell3aa.setPaddingTop(1);	
			footerTable3aaa.addCell(footerTable_cell3aa);
			
			footerTable_cell3aa = new PdfPCell(new Phrase(" "));
			footerTable_cell3aa.setHorizontalAlignment(Element.ALIGN_RIGHT);
			footerTable_cell3aa.setBorder(Rectangle.BOTTOM | Rectangle.RIGHT);
			footerTable_cell3aa.setPaddingBottom(1);
			footerTable_cell3aa.setPaddingTop(1);	
			footerTable3aaa.addCell(footerTable_cell3aa);
			
			footerTable_cell3aa = new PdfPCell(new Phrase(" ",Normalfont10));
			footerTable_cell3aa.setHorizontalAlignment(Element.ALIGN_CENTER);
			footerTable_cell3aa.setBorder(Rectangle.BOTTOM | Rectangle.RIGHT);
			footerTable_cell3aa.setPaddingBottom(1);
			footerTable_cell3aa.setPaddingTop(1);	
			footerTable3aaa.addCell(footerTable_cell3aa);
			...
			footerTable_cell3aa = new PdfPCell(new Phrase(" ", font14Bold));
			footerTable_cell3aa.setHorizontalAlignment(Element.ALIGN_CENTER);
			footerTable_cell3aa.setBorder(Rectangle.BOTTOM | Rectangle.RIGHT);
			footerTable_cell3aa.setPaddingBottom(1);
			footerTable_cell3aa.setPaddingTop(1);	
			...
			document.add(footerTable3aaa);
			
			
			PdfPTable footerTable3aa = new PdfPTable(4);
			footerTable3aa.setWidthPercentage(100);

			float[] footerColumnWidths3a = {0.1f,0.9f,0.1f,0.3f};
			...
			footerTable_cell3a.setBorder(Rectangle.BOTTOM | Rectangle.LEFT | Rectangle.RIGHT);
			footerTable_cell3a.setPaddingBottom(3);
			footerTable_cell3a.setPaddingTop(3);
			footerTable3aa.addCell(footerTable_cell3a);
			
			footerTable_cell3a = new PdfPCell(new Phrase(""));
			footerTable_cell3a.setHorizontalAlignment(Element.ALIGN_RIGHT);
			footerTable_cell3a.setBorder(Rectangle.BOTTOM | Rectangle.RIGHT);
			footerTable_cell3a.setPaddingBottom(3);
			footerTable_cell3a.setPaddingTop(3);
			footerTable3aa.addCell(footerTable_cell3a);
			
			footerTable_cell3a = new PdfPCell(new Phrase("TOTAL",Normalfont7));
			footerTable_cell3a.setHorizontalAlignment(Element.ALIGN_CENTER);
			footerTable_cell3a.setBorder(Rectangle.BOTTOM | Rectangle.RIGHT);
			footerTable_cell3a.setPaddingBottom(3);
			footerTable_cell3a.setPaddingTop(3);
			footerTable3aa.addCell(footerTable_cell3a);
...
/* 			footerTable_cell3a = new PdfPCell(new Phrase("Discount Amount  :  "+dd+"        Net Amount    : "+gg, font8Bold));
			...
			footerTable_cell3a = new PdfPCell(new Phrase(""+aa, font14Bold));
			footerTable_cell3a.setHorizontalAlignment(Element.ALIGN_CENTER);
			footerTable_cell3a.setBorder(Rectangle.BOTTOM | Rectangle.RIGHT);
			footerTable_cell3a.setPaddingBottom(3);
			footerTable_cell3a.setPaddingTop(3);
...
/* 			PdfPTable footerTable3aaaa = new PdfPTable(4);
			footerTable3aaaa.setWidthPercentage(100);

			float[] footerColumnWidths3aaa = {0.1f,0.9f,0.1f,0.3f};
			footerTable3aaaa.setWidths(footerColumnWidths3aaa);

			PdfPCell footerTable_cell3aaa;


			footerTable_cell3aaa = new PdfPCell(new Phrase(" "));
			footerTable_cell3aaa.setHorizontalAlignment(Element.ALIGN_RIGHT);
			footerTable_cell3aaa.setBorder(Rectangle.BOTTOM | Rectangle.LEFT);
			footerTable_cell3aaa.setPaddingBottom(1);	
			footerTable3aaaa.addCell(footerTable_cell3aaa);
			
			footerTable_cell3aaa = new PdfPCell(new Phrase(" "));
			footerTable_cell3aaa.setHorizontalAlignment(Element.ALIGN_RIGHT);
			footerTable_cell3aaa.setBorder(Rectangle.BOTTOM);
	//		footerTable_cell3aa.setPaddingBottom(10);
			footerTable_cell3aaa.setPaddingBottom(1);	
			footerTable3aaaa.addCell(footerTable_cell3aaa);
			
			footerTable_cell3aaa = new PdfPCell(new Phrase(" ",Normalfont10));
			footerTable_cell3aaa.setHorizontalAlignment(Element.ALIGN_CENTER);
			footerTable_cell3aaa.setBorder(Rectangle.BOTTOM);
	//		footerTable_cell3aa.setPaddingBottom(10);
			footerTable_cell3aaa.setPaddingBottom(1);	
			footerTable3aaaa.addCell(footerTable_cell3aaa);
			...
			footerTable_cell3aaa = new PdfPCell(new Phrase(" ", font14Bold));
			footerTable_cell3aaa.setHorizontalAlignment(Element.ALIGN_CENTER);
			footerTable_cell3aaa.setBorder(Rectangle.BOTTOM | Rectangle.RIGHT);
	//		footerTable_cell3aa.setPaddingBottom(10);
				footerTable_cell3aaa.setPaddingBottom(1);	
			footerTable3aaaa.addCell(footerTable_cell3aaa);
			
			document.add(footerTable3aaaa); */
			
			
			PdfPTable footerTable3 = new PdfPTable(2);
			footerTable3.setWidthPercentage(100);

			float[] footerColumnWidths3 = { 0.5f,0.5f };
			footerTable3.setWidths(footerColumnWidths3);

			PdfPCell footerTable_cell3;

			
			footerTable_cell3 = new PdfPCell(new Phrase("           TIME \n \n 10:30 AM to 7 PM \n \n Smile is best medicine in the world", font12Bold));
			footerTable_cell3.setHorizontalAlignment(Element.ALIGN_LEFT);
			footerTable_cell3.setPaddingLeft(5);
			footerTable_cell3.setPaddingBottom(3);
			footerTable_cell3.setPaddingTop(15);
			footerTable_cell3.setBorder(Rectangle.LEFT | Rectangle.BOTTOM | Rectangle.TOP);
			footerTable3.addCell(footerTable_cell3);


			footerTable_cell3 = new PdfPCell(new Phrase("FOR \n \n \n  ARYAN ENTERPRISE ",font14Bold));
			footerTable_cell3.setHorizontalAlignment(Element.ALIGN_CENTER);
			footerTable_cell3.setPaddingBottom(3);			
			footerTable_cell3.setPaddingTop(15);
	//		footerTable_cell3.setPaddingRight(20);
			footerTable_cell3.setBorder(Rectangle.RIGHT | Rectangle.BOTTOM | Rectangle.TOP);
			footerTable3.addCell(footerTable_cell3);
