...
/* 	response.setContentType("application/pdf");
	...
	try {
		...
		ResultSet rs = stmt.executeQuery("select fertilizer_billing.bill_no, fertilizer_billing.customer_name, fertilizer_billing.product_name, fertilizer_billing.sale_price,fertilizer_billing.village, fertilizer_billing.company, fertilizer_billing.weight,fertilizer_billing.unit, fertilizer_billing.quantity, fertilizer_billing.total_per_product, fertilizer_billing.total_all_product, fertilizer_billing.transportation_expense, fertilizer_billing.hamali_expense, fertilizer_billing.gross_total , fertilizer_billing.tax_percentage,fertilizer_billing.hsn,fertilizer_billing.igstPercentage from fertilizer_billing where bill_no=62");
		...
		table_cell = new PdfPCell(new Phrase("Lic No (W) : LAFD25060098",font9NoBold));
		table_cell.setBorder(table_cell.NO_BORDER);
		table.addCell(table_cell);

		//-----------------

		table_cell = new PdfPCell(new Phrase("GSTIN - 27AAAHV5757P1ZA", Normalfont11));
		table_cell.setBorder(table_cell.NO_BORDER);
		table.addCell(table_cell);
		...
		table_cell = new PdfPCell(new Phrase("Lic No(F)     : LAFD25060096", font9NoBold));
		table_cell.setBorder(table_cell.NO_BORDER);
		...
		table_cell = new PdfPCell(new Phrase("Dudulwar Agencies", font17));
		table_cell.setBorder(table_cell.NO_BORDER);
		table_cell.setPaddingTop(2f);
		table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
		table.addCell(table_cell);

		table_cell = new PdfPCell(new Phrase("Lic No(I)      : LAID25060036", font9NoBold));
		...
		table_cell = new PdfPCell(new Phrase("Main road Arni, Dist:- Yavatmal", Normalfont11));
		table_cell.setBorder(Rectangle.BOTTOM);
		table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
		table_cell.setPaddingBottom(2f);
		table.addCell(table_cell);

		table_cell = new PdfPCell(new Phrase("Lic No(S)     : LASD25060076", font9NoBold));
		table_cell.setBorder(Rectangle.BOTTOM);
		table_cell.setPaddingBottom(2f);
		table.addCell(table_cell);
...
/* 
		...
		if (b > 0 && b <= 10) {
			...
			table_cell4 = new PdfPCell(new Phrase(
					"\n Customer Sign                                                                      From Dudulwar Agencies Arni",
					Normalfont11));
			table_cell4.setColspan(10);
			table_cell4.setHorizontalAlignment(Element.ALIGN_CENTER);
