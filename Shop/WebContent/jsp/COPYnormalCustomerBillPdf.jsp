...
System.out.println("ln no ==>72 Bill No ===> "+billno+" Customer Name ===> "+creditCustomerName+" Shop Name ===> "+onlyShopName);
...
try {
	...
	rs.first();
		...
		{ */
			...
			table_cell = new PdfPCell(new Phrase("Bill Copy(Cash)", font9NoBold));
