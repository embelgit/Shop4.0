							...
							<form class="form-horizontal" method="post" action="" name="saleReportForm22">
								<fieldset>
									<div class="row form-group" style="margin-top: 30px">
										...
										<label class="col-md-2 control-label" for=""> Enter	Date:<sup>*</sup>
										</label>
										<div class="col-md-3">
											<div class="input-group">
												<span class="input-group-addon"> <i
									...
									<div class="row form-group" style="padding-top:2%">
										<div class="col-md-2 col-md-offset-5">
											<div class="input-group">
												<div align="center">
													<input type="button" id="btn" name="save" class="btn  btn-success " style="height: 38px; width: 121px;font-size: 18" onclick="allReportForSingleDate()" value="Search" />
												</div>
											</div>
										</div>
									</div>
										...
										<div class="col-md-2 col-md-offset-5">
											<div class="input-group">
												<input type="button" id="btn" name="save" class="btn  btn-success " style="height: 38px; width: 121px;font-size: 18"
													   onclick="allReportBetweenTwoDates()"
													value="Search" />
											</div>
										</div>
									</div>
