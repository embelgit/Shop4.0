...
<body id="dt_example">
	<div class="container-fluid">	
		<div class="row" style="margin-top:70px">
			<div align="center">
				<h2 class="form-name style_heading " >Credit Note Payment List</h2>
			</div>
	...
	List list12=dao.getcreditpaymentList();
	%>
	<div class="container-fluid">
	 <div class="row">
			...
			<tbody>
   				<%
						for(int i=0;i<list12.size();i++){
							creditnotebean sr=(creditnotebean)list12.get(i);
				%>
				
				<tr>
					<td class="align"><%=sr.getPartyname()%></td>
