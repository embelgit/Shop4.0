...
<%@page import="com.Fertilizer.dao.FertilizerBillDao"%>
 ...
 <%@page import="com.Fertilizer.hibernate.challanBeanH"%>
           			...
           			<div class="col-lg-3 col-md-3 col-sm-8">
						<div class="input-group">
							...
							CustomerDetailsDao dao = new CustomerDetailsDao();
           						List cust = dao.getAllchallan(request);
							%>
							<input type="text" id="billNo" list="billno_drop" placeholder="Select challan No" class="form-control">
