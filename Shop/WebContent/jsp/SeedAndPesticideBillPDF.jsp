...
<%
	response.setContentType("application/pdf");
	 Long billno = (Long) session.getAttribute("SeedBillNo");
	 String creditCustomerName = (String) session.getAttribute("SeedcreditCustomerName"); 
	...
	try {
		...
		ResultSet rs = stmt.executeQuery("select customer_name, seed_pesticide_billing.product_name, seed_pesticide_billing.village, seed_pesticide_billing.company, seed_pesticide_billing.weight, seed_pesticide_billing.quantity, seed_pesticide_billing.sale_price, seed_pesticide_billing.total_per_product, seed_pesticide_billing.total_all_product, seed_pesticide_billing.transportation_expense, seed_pesticide_billing.hamali_expense, seed_pesticide_billing.gross_total, seed_pesticide_billing.tax_percentage from seed_pesticide_billing where bill_no =" + billno);
