...
<link href="/Shop/staticContent/css/dataTa.css" rel="stylesheet"
...
<link rel="stylesheet"
	href="/Shop/staticContent/css/dataTables.jqueryui.min.css">
				...
				<li><a href="#saleReturnReport" data-toggle="tab" style=" border-radius:12px;"> Sale Return Report</a></li>
		     	<li><a href="#billcancelReport" data-toggle="tab" style=" border-radius:12px;">Bill Cancel Report</a></li>  -->
						...
						<li class="active"><a href="#home" data-toggle="tab">Category
								Wise Report </a></li>
						<li><a href="#profile" data-toggle="tab">Product Name
								Wise </a></li>
						<li><a href="#payment" data-toggle="tab">Payment Mode
								Wise </a></li>
						<li><a href="#shopWise" data-toggle="tab">Shop Wise
								Report </a></li>
						<li><a href="#userWise" data-toggle="tab">User Wise
								Report </a></li>
						<li><a href="#GSTWise" data-toggle="tab">GST Wise
								Reports</a></li>
						<li><a href="#nonGSTWise" data-toggle="tab">Non-GST Wise
								Reports</a></li>
						<li><a href="#rangeWiseBillReport" data-toggle="tab">Range
								Wise Report</a></li>
						<li><a href="#cashCustomerSaleReport" data-toggle="tab">Cash
								Customer Report </a></li>
						<li><a href="#creditCustomerSaleReport" data-toggle="tab">Credit
								Customer Report </a></li>
						<li><a href="#saleReturnReport" data-toggle="tab"> Sale
								Return Report</a></li>
						<li><a href="#billcancelReport" data-toggle="tab">Bill
								Cancel Report</a></li>
						...
						<div class="tab-pane active" id="home">
							...
							<ul class="nav nav-tabs">
								<li class="active"><a data-toggle="tab"
									href="#supplierSingleDate" style="border-radius: 23px;">
										<h4>Datewise</h4>
								</a></li>
		        ...
		        buttons: [
		            'copy', 'csv', 'excel', 'pdf', 'print'
											...
											<div class="row form-group" style="margin-top: 30px">
												...
												<div class="col-md-3">
													<div class="input-group">
														...
														%>
														<input list="cat_drop6" id="fk_cat_id6"
										...
										<fieldset>
											<div class="row form-group" style="margin-top: 30px">
												<label class="col-md-3   control-label"
													for="fk_cat_id_for_payment_mode_two">Product
													Category<sup>*</sup>
												</label>
												<div class="col-md-3">
													<div class="input-group ">
														...
														%>
														<input list="cat_drop_For_payment_mode_two1"
						...
						<div class="tab-pane" id="profile">
							...
							<ul class="nav nav-tabs">
								<li class="active"><a data-toggle="tab"
									href="#customerSingleDate" style="border-radius: 23px;">
										<h4>Datewise</h4>
								</a></li>
											...
											<div class="row form-group" style="margin-top: 30px">
												...
												<div class="col-md-3">
													<div class="input-group">
														...
														%>
														<input list="cat_drop" id="fk_cat_id" name="fk_cat_id"
									...
									<form class="form-horizontal" method="post" action=""
										...
										<fieldset>
											<div class="row form-group" style="margin-top: 30px">
												...
												<label class="col-md-3 control-label" for="product">Product
													Name<sup>*</sup>
												</label>
												<div class="col-md-3">
													<div class="input-group">
														<span class="input-group-addon"> <i
															class="	glyphicon glyphicon-list-alt"></i>
														</span> <select class="form-control" id='proName1'
															name="proName1" placeholder="Product	Name">
														</select>
											...
											<div class="row form-group" style="margin-top: 18px">
												<label class="col-md-3 control-label" for="customerName">Start
													Date:<sup>*</sup>
												</label>
												<div class="col-md-3">
													<div class="input-group">
												...
												<label class="col-md-3 control-label" for="village">End
													Date:<sup>*</sup>
												</label>
												<div class="col-md-3">
													<div class="input-group">
						...
						<div class="tab-pane" id="payment">
							...
							<ul class="nav nav-tabs">
								...
								<li class="active"><a data-toggle="tab"
									href="#dateWisePaymentMode" style="border-radius: 23px;">
										<h4>DateWise</h4>
								</a></li>
								<!--   	<li><a data-toggle="tab" href="#rangeWisePaymentMode"><h4 style="color:blue">Range and Category Wise</h4></a></li> -->
								<li><a data-toggle="tab"
									href="#rangeWisePaymentTypePaymentMode"
									style="border-radius: 23px;">
										<h4>Range and Payment Mode Wise</h4>
								</a></li>
												...
												<div class="col-md-2 col-md-offset-5">
													<div class="input-group">
														<input type="button" id="btn" name="save"
															class="btn  btn-success"
															style="height: 38px; width: 121px; font-size: 18"
															onclick="paymentModeReportAsPerSingleDate()"
															value="Search" />
													</div>
												</div>
											</div>
											...
											<div class="row form-group" style="margin-top: 30px">
												...
												<div class="col-md-3">
													<div class="input-group">
														<span class="input-group-addon"> <i
															class="glyphicon glyphicon-calendar"></i>
														</span> <input type="date" id="fisDateForPay4"
															placeholder="Start Date" class="form-control input-md"
															type="text">
													</div>
												</div>
												...
												<div class="col-md-3">
													<div class="input-group">
														<span class="input-group-addon"> <i
															class="glyphicon glyphicon-calendar"></i>
														</span> <input type="date" id="endDateForPay4"
															placeholder="End Date"
															class="form-control input-md ac_district" type="text">
													</div>
												</div>
								...
								onclick="saleReportBetweenTwoDatesAsPerShopValidate()" value="Search"/> -->
											...
											<div class="container">
												<div class="table-responsive">
													<table
														class="table table-bordered table-striped table-condensed cf"
														id="rangeWisePaymentTypePaymentModeDataTable"
														class="display">
														<thead>
															<tr>
																<th>Customer Bill No</th>
	 ...
	 $(document).ready(function() {
				...
				<label class="col-md-2 control-label" for="fk_cat_id">Product Category<sup>*</sup></label>  
					...
					<table id="sale1" class="display" style=" border: 2px solid black;border-collapse: collapse;">
									...
									<form class="form-horizontal" method="post" action=""
										...
										<fieldset>
											<div class="row form-group" style="margin-top: 20px">
												<label class="col-md-3 control-label" for="fk_shop_id">Shop
													Name<sup>*</sup>
												</label>
												<div class="col-md-3">
													<div class="input-group">
											...
											<div class="row form-group">
												...
												<label class="col-md-3 control-label" for="endDate">End
													Date:<sup>*</sup>
												</label>
												<div class="col-md-3">
													<div class="input-group">
							...
							<div class="tab-content">
								...
								<div id="#shopBetweenTwoDate" class="tab-pane active">
									...
									<form class="form-horizontal" method="post" action=""
										...
										<fieldset>
											<div class="row form-group" style="margin-top: 20px">
												<label class="col-md-3 control-label" for="fk_shop_id">User
													Name<sup>*</sup>
												</label>
												<div class="col-md-3">
													<div class="input-group">
														...
														<input list="shp_dropp" id="fkShopIdd"
											...
											<div class="row form-group">
												...
												<div class="col-md-3">
													<div class="input-group">
														<span class="input-group-addon"> <i
															class="glyphicon glyphicon-calendar"></i>
														</span> <input type="date" id="fisDate11"
															placeholder="Start Date" class="form-control input-md"
															type="text">
													</div>
												</div>
							...
							<form class="form-horizontal" method="post" action="" name="gst">
								<fieldset>
									...
									<div class="row form-group">
										...
										<div class="col-md-3">
											<div class="input-group ">
												...
												<input list="cat_drop_For_GST" id="fk_cat_id_for_GST"
													class="form-control"
													onchange="getAllProductforGSTwiseReports()"
													placeholder="Product Category">
										...
										<label class="col-md-2 control-label" for="gstwsproName">Product
											Name<sup>*</sup>
										</label>
										<div class="col-md-3">
											<div class="input-group">
												<span class="input-group-addon"> <i
													class="	glyphicon glyphicon-list-alt"></i>
												</span> <select class="form-control" id="gstwsproName"
													name="gstwsproName">
									...
									<div class="container">
										<div class="table-responsive">
											...
											<table
												class="table table-bordered table-striped table-condensed cf"
												id="gstSale2" class="display table table-boardered">
												<thead>
												...
												<tfoot>
													<tr>
														<th colspan="17" style="text-align: right">Total Rs:</th>
													</tr>
												</tfoot>
											</table>
						...
						<div class="tab-pane" id="nonGSTWise">
							<div class="row">
								<div align="center">
									<h2 class="form-name style_heading">Non-GST Wise Sale
										Reports</h2>
								</div>
									...
									<div class="row form-group" style="margin-top: 30px">
										...
										<div class="col-md-3">
											<div class="input-group">
												<span class="input-group-addon"> <i
													class="glyphicon glyphicon-calendar"></i>
												</span> <input type="date" id="nongstFisDate"
													placeholder="Start Date" class="form-control input-md">
											</div>
										</div>
										...
										<div class="col-md-3">
											<div class="input-group">
												<span class="input-group-addon"> <i
													class="glyphicon glyphicon-calendar"></i>
												</span> <input type="date" id="nongstEndDate"
													placeholder="End Date"
									...
									<div class="row form-group">
										...
										<div class="col-md-3">
											<div class="input-group ">
												...
												%>
												<input list="cat_drop_For_nonGST" id="fk_cat_id_for_nonGST"
													class="form-control" placeholder="Product Category">
										...
										<div class="col-md-3 Col-md-offset-5">
											<div class="input-group">
												<input type="button" id="btn" name="save"
													class="btn  btn-success "
													style="height: 38px; width: 121px; font-size: 18"
													onclick="nongstWiseSaleReportValidation()" value="Search" />
											</div>
										</div>
									</div>
									<div class="container">
							...
							<div class="tab-content">
								...
								<div id="#saleReturn1" class="tab-pane active">
									...
									<form class="form-horizontal" method="post" action=""
										...
										<fieldset>
											<div class="row form-group">
												<label class="col-md-2 control-label" for="billNo">Bill
													No</label>
												<div class="col-md-3">
													<div class="input-group "">
														<span class="input-group-addon"> <i
														...
														%>
														<input list="bill_no_drop" id="bill_no"
															class="form-control">
						...
						<div class="tab-pane" id="rangeWiseBillReport">
							<div class="row">
								<div align="center">
									<h2 class="form-name style_heading">Range Wise Sale
										Reports</h2>
								</div>
								...
								<form class="form-horizontal" method="post" action=""
									...
									<fieldset>
										<div class="row form-group" style="margin-top: 30px">
											...
											<label class="col-md-2 control-label" for="fisDateForPay">
												Start Date:<sup>*</sup>
											</label>
											<div class="col-md-3">
												<div class="input-group">
													<span class="input-group-addon"> <i
														class="glyphicon glyphicon-calendar"></i>
													</span> <input type="date" id="fisDateForBillReport"
														placeholder="Start Date" class="form-control input-md"
														type="text">
												</div>
											</div>

											<label class="col-md-3 control-label" for="endDateForPay">End
												Date:<sup>*</sup>
											</label>
											<div class="col-md-3">
												<div class="input-group">
													<span class="input-group-addon"> <i
														class="glyphicon glyphicon-calendar"></i>
													</span> <input type="date" id="endDateForBillReport"
														placeholder="End Date"
														class="form-control input-md ac_district" type="text">
												</div>
											</div>
						...
						<div class="tab-pane" id="creditCustomerSaleReport">
							...
							<ul class="nav nav-tabs">
								<li class="active"><a data-toggle="tab"
									href="#creditCustomerSaleReportsSingleDateWise"
									style="border-radius: 23px;">
										<h4>Bill No. and Name Wise</h4>
								</a></li>
										...
										<fieldset>
											<div class="row form-group" style="margin-top: 30px">
												...
												<div class="col-md-3">
													<div class="input-group">
														...
														<%
															...
															List cList =cdd.getAllMainCat(); */
														%>
														<input list="creditCustDrop" id="creditCustBillId"
															placeholder="Credit Customer Name" class="form-control">
												...
												<label class="col-md-2 control-label"
													for="fDateCrteditCustSingleDate"> Enter Date:<sup>*</sup>
												</label>
												<div class="col-md-3">
													<div class="input-group">
														<span class="input-group-addon"> <i
															class="glyphicon glyphicon-calendar"></i>
														</span> <input type="date" id="fDateCrteditCustSingleDate"
															placeholder="Start Date" class="form-control input-md"
															type="text">
													</div>
												</div>
											...
											<div class="container">
												<div class=" table-responsive ">
													<table
														class="table table-bordered table-striped table-condensed cf"
														id="creditCustSaleReportSingledate" class="display ">
														<thead>
															<tr>
																<th>Customer Bill No</th>
																<th>Product Name</th>
		    ...
		    <!--  <div class="tab-pane active" id="creditCustomerSaleReport"> -->
						<div class="tab-pane" id="cashCustomerSaleReport">
							...
							<ul class="nav nav-tabs">
								<li class="active"><a data-toggle="tab"
									href="#cashCustomerSaleReportsSingleDateWise"
									style="border-radius: 23px;">
										<h4>Bill No and Name Wise</h4>
								</a></li>
								<!--    <li><a data-toggle="tab" href="#creditCustomerSaleReportsDateRangeWise"><h4 style="color:blue">Range</h4></a></li> -->
										...
										<fieldset>
											<div class="row form-group" style="margin-top: 20px">
												...
												<label class="col-md-3 col-md-offset-3 control-label"
													for="cashCustBillId">Cash Customer Name<sup>*</sup>
												</label>
												<div class="col-md-3">
													<div class="input-group">
														<span class="input-group-addon"> <i
														...
														<%
															...
															List cList =cdd.getAllMainCat(); */
														%>
														<input list="cashCustDrop" id="cashCustBillId"
									...
									class="form-control input-md" type="text">
											...
											<div class="row form-group">
												<div class="col-md-3 col-md-offset-5 ">
													<div class="input-group">
														<div align="center">
															<input type="button" id="cashCustbtn1"
																name="cashCustbtn1" class="btn  btn-success "
										...
										<fieldset>
											...
											<div class="container">
												<div class="table-responsive">
													<table
														class="table table-bordered table-striped table-condensed cf"
														id="saleReturnTable" class="display">
														<thead>
															<tr>
																<th>Product Name</th>
																<th>Company</th>
										...
										<div class="row form-group" style="margin-top: 30px">
											...
											<div class="col-md-3">
												<div class="input-group">
													<span class="input-group-addon"> <i
														class="glyphicon glyphicon-calendar"></i>
													</span> <input type="date" id="StartDate10"
														placeholder="Start Date" class="form-control input-md"
														type="text">
												</div>
											</div>
											...
											<div class="col-md-3">
												<div class="input-group">
													<span class="input-group-addon"> <i
														class="glyphicon glyphicon-calendar"></i>
													</span> <input type="date" id="EndDate10" placeholder="End Date"
														class="form-control input-md ac_district" type="text">
												</div>
											</div>
											<div class="col-md-2 col-md-offset-5 text-center"
												...
												<input type="button" id="save" name="save"
													style="height: 38px; width: 121px; font-size: 18"
													class="btn  btn-success "
													onclick="billReportBetweenTwoDate()" value="Submit">
											</div>
										</div>
										<div class="form-group row"></div>
										<div class="container">
