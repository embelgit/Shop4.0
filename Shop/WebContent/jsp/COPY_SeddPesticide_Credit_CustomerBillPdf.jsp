...
<%
	...
	Long billno = (Long) session.getAttribute("CrditCustBillNo");
	...
	try {
		...
		ResultSet rs = stmt.executeQuery("select customer_details.first_name, customer_details.middle_name, customer_details.last_name ,seed_pesticide_billing.product_name, seed_pesticide_billing.village, seed_pesticide_billing.company, seed_pesticide_billing.weight, seed_pesticide_billing.quantity, seed_pesticide_billing.sale_price, seed_pesticide_billing.total_per_product, seed_pesticide_billing.total_all_product, seed_pesticide_billing.transportation_expense, seed_pesticide_billing.hamali_expense, seed_pesticide_billing.gross_total, insert_date,seed_pesticide_billing.tax_percentage  from seed_pesticide_billing  left join customer_details on seed_pesticide_billing.fk_customer_id = customer_details.pk_customer_id where bill_no =" + billno);
