			 	...
			 	<div class="row">
			 		<div class="form-group">
 						...
 						<div class="col-lg-2 col-md-2 col-sm-4 formspacelabel">
           					<label class="control-label" for="unitName">New Category Name<sup>*</sup></label>  
           	 			</div>	
		            ...
		            <!--  "customerDetails()" function is implemented in customerDetails.js  -->
	           		 <input type="button" id="save" name="btn" class="btn btn-success " onclick="EditcatDetails()" value="Update">
	           		 <input id="save" name="btn" class="btn  btn-danger " type="reset"  onclick="reset()" value="Cancel">
	           		 <input type="button" id="listBtn"  name="btn" class="btn btn-primary" onclick="back()" value="Back"/> 
