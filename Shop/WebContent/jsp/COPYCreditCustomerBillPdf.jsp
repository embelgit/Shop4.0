...
/* /* Long billno = (Long) session.getAttribute("NormalCustFertilizerBillNo"); 
Long billno = 12l;
String creditCustomerName = (String) session.getAttribute("creditCustomerName"); 

System.out.println("ln no ==>66 Bill No ===> "+billno+" Customer Name ===> "+creditCustomerName); */
 ...
 System.out.println("Bill No From Credit Customer =======> "+billno);
/*  String creditCustomerName = (String) session.getAttribute("creditCustomerName");  
 System.out.println("creditCustomerName From Credit Customer =======> "+creditCustomerName); */
/*
 response.setContentType("application/pdf");
...
try {
	...
	rs.first();
		...
		{ */
			...
			table_cell = new PdfPCell(new Phrase("Bill Copy(Credit)", font9NoBold));
...
*/
		...
		float[] columnWidths3 = { 0.5f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.3f};
		...
		float[] columnWidths4 = { 0.5f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.3f};
		table4.setWidths(columnWidths4);

		PdfPTable table5 = new PdfPTable(8);
		table5.setWidthPercentage(100);

		float[] columnWidths5 = { 0.5f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.3f};
		table5.setWidths(columnWidths5);

		PdfPTable table6 = new PdfPTable(8);
		table6.setWidthPercentage(100);

		float[] columnWidths6 = { 0.5f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.3f};
