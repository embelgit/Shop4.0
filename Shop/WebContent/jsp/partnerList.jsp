		...
		<table id="list" class="display" border="1">
			...
			<tbody>
				...
				<tr>
					...
					<td class="align"><i class="glyphicon glyphicon-trash" style="font-size:27px;margin-left:50px" id="<%=sr.getPkPartnerId()%>,<%=sr.getPartnerName()%>" onclick="delpartner(this.id);return false;"></i></td>																			
				</tr>
