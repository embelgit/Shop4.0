...
<%
	...
	String partyname = (String)session1.getAttribute("partyname");
	...
	try {
		...
		ResultSet rs = stmt.executeQuery("select party_name, description, amount, transaction_no, shop_name from creditnotegeneration  where party_name='"+partyname+"'");
		...
		table_cell = new PdfPCell(new Phrase("Credit Note", font15Bold));
		table_cell.setBorder(table_cell.NO_BORDER);
		table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
		table.addCell(table_cell);
		...
		table_cell = new PdfPCell(new Phrase(shopName));
		table_cell.setBorder(table_cell.NO_BORDER);
		table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
		table.addCell(table_cell);
		...
		String creditGenNo=rs.getString("transaction_no");
		table_cell = new PdfPCell(new Phrase("Credit Gen. No :: "+creditGenNo));
		table_cell.setBorder(Rectangle.BOTTOM);
		...
		table_cell2 = new PdfPCell(new Phrase("Party Name: "+pname));
		...
		table_cell3 = new PdfPCell(new Phrase("Description", font12));
		...
		while (rs.next()) {
			...
			String Particular = rs.getString("description");
			
			table_cell3 = new PdfPCell(new Phrase(""+Particular, font12NoBold));
			table_cell3.setHorizontalAlignment(Element.ALIGN_CENTER);
			table_cell3.setBorder(Rectangle.RIGHT | Rectangle.LEFT);
			table_cell3.setBorderWidth(1f);
			...
			table_cell3 = new PdfPCell(new Phrase(""+amount, font12NoBold));
			table_cell3.setBorder(Rectangle.RIGHT | Rectangle.LEFT);
			table_cell3.setHorizontalAlignment(Element.ALIGN_CENTER);
			table_cell3.setBorderWidth(1f);
			table_cell3.setPaddingTop(2);
			...
			double creditamt=Double.parseDouble(amount);
		...
		table_cell3 = new PdfPCell(new Phrase("\n\n\n Checked By 										               					                   From Embel Technologies,Warje", font12NoBold));
		table_cell3.setColspan(10);
		table_cell3.setHorizontalAlignment(Element.ALIGN_CENTER);
		table_cell3.setBorder(Rectangle.RIGHT | Rectangle.LEFT | Rectangle.BOTTOM);
		table_cell3.setBorderWidth(1f);
