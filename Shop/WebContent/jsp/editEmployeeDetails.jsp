			...
			<div class="row form-group">
 			...
 			<div class="form-group row" style="padding-top:2%">
            	...
            	<!--  "employeedetails()" function is implemented in employeeDetails.js  -->
    	          	 ...
    	          	 <input type="button" id="save" name="btn" style="font-size: 25;width: 128px; height: 53px;" class="btn  btn-success "  onclick="editEmployee()" value="Submit">
	           		 <input id="save" name="btn"  class="btn  btn-danger" style="font-size: 25;width: 128px; height: 53px;"  type="reset"  onclick="reset()" value="Cancel">
        	    	...
        	    	<input type="button" value="Back" id="listBtn" style="font-size: 25;width: 128px; height: 53px;"  class="btn  btn-primary" onclick="Back()" /> 
        	    </div>
          	</div>
