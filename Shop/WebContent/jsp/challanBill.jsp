...
<div class="row">
	...
	<div class="row header_margin_top">
 	...
 	<p align="right"  style="font-size: 22px; padding-right: 120px" >Challan No : <%=billNumber%></p>
    <div class="row">
 ...
 <!----------------------------------------------------------- CODE FOR CREDIT CUSTOMER ---------------------------------------------------------->
       ...
       <div id="CreditCustDetail" style="padding-top:2%">
         ...
         <div class="row form-group">
			...
			<label class="col-md-3 control-label" for="contactNo1">Contact No.</label>  
	 	   	...
	 	   	<div class="row form-group">
              	...
              	<label class="col-md-2 control-label" for="productName">Challan No:</label>  
         ...
         <div class="table-responsive row" align="center" style="margin-left: 30px; width:1340px" >
          ...
          <div class="row form-group" >
          	 	   	...
          	 	   	<div class="row form-group">
              	<label class="col-md-3 control-label" for="productName">Email ID:</label>  
	 ...
	 <script>
		...
		<div class="row form-group" style="padding-top: 28px">
				<div align="center">
					
					<input type="button" id="billingCreditBtn" style="font-size: 25;width: 128px; height: 53px;" class="btn btn-large btn-success button-height-width" name="billingCreditBtn" onclick="challanBillingV()" value="Print Bill">
