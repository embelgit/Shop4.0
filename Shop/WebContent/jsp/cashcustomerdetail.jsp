...
<!--  <script type="text/javascript" src="/Shop/staticContent/js/customerDetails.js"></script> -->
 <script type="text/javascript" src="/Shop/staticContent/js/cashcustdetail.js"></script>
		
<script type="text/javascript">
 function Customerlist()
 {
 	 window.location = "cashCustomerList.jsp";
 }
...
<div class="row header_margin_top">
    <div align="center">
  		<h2 class="form-name style_heading"><%if(abc.equals("marathi")){%><%=PropertiesHelper.marathiProperties.getProperty("customerdetails") %> <%}%> <%if(abc.equals("english")){%>Cash Customer Details <%}%> </h2>
  	</div>
</div>
     <div class="row">
