...
<div id="CashCustDetail" style="padding-top:2%">
     ...
     <form class="form-horizontal" method="post" action="" name="fertiBill">
			<fieldset>
			  ...
			  <div class="row form-group">
			<label class="col-md-2 control-label" for="customerType">All Bill No<sup>*</sup></label>  
           			 <div class="col-md-3">
                 ...
                 <!-- <div class="row form-group"> -->
           			 <label class="col-md-2 control-label" for="billNo">Today's Bill No <sup>*</sup></label>  
            			<div class="col-md-3">
							<div class="input-group " ">
								<span class="input-group-addon">
										No
         		  ...
         		  <div class="form-group row" style="padding-top:2%">
            		<div class="col-md-6 col-md-offset-3  text-center">
              			<input type="button" id="save" name="save" style=" height: 53px; width: 128px; font-size: 25" class="btn btn-success" value="Submit" onclick="billReturnVal()">
