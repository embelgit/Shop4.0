...
{		
		...
		private Long fk_product_Pk_Id;
		private Long fk_unit_Pk_Id;
		private Long fk_tax_Id;
		private Long fk_subCat_id;	
		private Double TotalExclTax;
		private Double gstExpensePerc;
		...
		public Double getGstExpensePerc() {
			return gstExpensePerc;
		}

		public void setGstExpensePerc(Double gstExpensePerc) {
			this.gstExpensePerc = gstExpensePerc;
		}
		...
		public challanBeanH(Long pkfertilizerBillId, String customerName, 
				...
				String nameOnCheck, Long checkNo, Long cardNo, Double discount,
				Double discountAmount, Double taxAmount, String accNo,
				String gstNo, String bankName, Long fk_shop_id, Long catId,
				Long subCatId, Long supplierId, Long fkGoodsReceive,
				...
				Long quantityAfterReturn, String hsn, Double iGst,
				Double billPaymentPending, Date saleDate, Double kg, Double grams,
				Double ltr, Double mili, String unit, Double totaGstTaxPerProduct,
				Double totaIgstTaxPerProduct, Double iGstTaxAmountPerUnit, Double freeQuantity,
				String creditcustomerName,Double netpayAmount,Long barcode,
				Double dicountperProdPerc,Double dicountperProdAmount, Double gstExpensePerc, Double hamaliExpenseTaxAmt )
		{
			super();
		...
		public Long getFk_product_Pk_Id() {
			return fk_product_Pk_Id;
		}

		public void setFk_product_Pk_Id(Long fk_product_Pk_Id) {
			this.fk_product_Pk_Id = fk_product_Pk_Id;
		}

		public Long getFk_unit_Pk_Id() {
			return fk_unit_Pk_Id;
		}

		public void setFk_unit_Pk_Id(Long fk_unit_Pk_Id) {
			this.fk_unit_Pk_Id = fk_unit_Pk_Id;
		}

		public Long getFk_tax_Id() {
			return fk_tax_Id;
		}

		public void setFk_tax_Id(Long fk_tax_Id) {
			this.fk_tax_Id = fk_tax_Id;
		}
