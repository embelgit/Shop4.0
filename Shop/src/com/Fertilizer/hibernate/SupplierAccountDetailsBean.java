...
public class SupplierAccountDetailsBean implements Serializable{
		...
		public SupplierAccountDetailsBean(Long pkSupplierAccDetailsId,
				Long fk_supplier_id, Long billNo, Double totalAmt,
				Date insertDate, SupplierDetailsBean supplierDetailsBean) {
			super();
			this.pkSupplierAccDetailsId = pkSupplierAccDetailsId;
			this.fk_supplier_id = fk_supplier_id;
			this.billNo = billNo;
